...
All diagrams use a dark background (#1a1a2e) with Claude Code A+BAY orange-blue accent (#FF7A00), consistent with Claude Code's official documentation style.
...
- [Claude Code A+BAY Home](/)
- [Memory System Documentation](/en/memory/01-usage-guide)
- [Agent Tool Source Code](https://github.com/aaronychu/claude-abay/tree/main/src/tools/AgentTool/)
- [Swarm Infrastructure](https://github.com/aaronychu/claude-abay/tree/main/src/utils/swarm/)
- [Task Management System](https://github.com/aaronychu/claude-abay/tree/main/src/tasks/)
