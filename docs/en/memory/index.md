...
All illustrations use a dark background (#1a1a2e) + Claude Code A+BAY orange-blue accent (#FF7A00) style, consistent with the official Claude Code documentation.
...
- [Claude Code A+BAY Home](/en/)
- [Memory system source code](https://github.com/aaronychu/claude-abay/tree/main/src/memdir/)
- [Auto-extraction service](https://github.com/aaronychu/claude-abay/tree/main/src/services/extractMemories/)
- [AutoDream service](https://github.com/aaronychu/claude-abay/tree/main/src/services/autoDream/)
- [DreamTask](https://github.com/aaronychu/claude-abay/tree/main/src/tasks/DreamTask/)
- [GitHub Issues](https://github.com/aaronychu/claude-abay/issues)
