...
Persist H5 settings in the existing claude-abay managed settings path (`~/.claude/claude-abay/settings.json`), preserving unknown fields and keeping the user-owned `~/.claude/settings.json` untouched:
