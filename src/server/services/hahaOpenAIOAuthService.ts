...
</head><body><div class="card"><h1>OpenAI Login Successful</h1><p>You can close this window and return to Claude Code A+BAY.</p></div>
...
export function getHahaOpenAIOAuthFilePath(): string {
  ...
  return path.join(configDir, 'claude-abay', 'openai-oauth.json')
}
