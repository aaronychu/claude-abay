...
</head><body><div class="card"><h1>✓ Grok Login Successful</h1><p>Authorization is complete. You can close this window and return to Claude Code A+BAY.</p></div><script>setTimeout(() => window.close(), 3000)</script></body></html>`
...
export function getHahaGrokOAuthFilePath(): string {
  ...
  return path.join(configDir, 'claude-abay', 'grok-oauth.json')
}
