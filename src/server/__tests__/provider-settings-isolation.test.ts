...
describe('provider settings isolation', () => {
  ...
  test('activating a provider writes only claude-abay/settings.json', async () => {
  ...
  test('activation preserves unrelated claude-abay settings and env', async () => {
  ...
  test('providers.json and claude-abay/settings.json stay isolated from Claude settings.json', async () => {
    await fs.writeFile(
