...
const desktopServerUrl = process.env.CLAUDE_ABAY_DESKTOP_SERVER_URL ?? process.env.CC_HAHA_DESKTOP_SERVER_URL;
...
/**
 * Load pre-authorized apps from ~/.claude/claude-abay/computer-use-config.json.
