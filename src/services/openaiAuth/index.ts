...
<html>
  <head>
    <meta charset="utf-8">
    <title>Claude Code A+BAY OpenAI Authorization Successful</title>
    <style>
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to Claude Code A+BAY.</p>
    </div>
...
<html>
  <head>
    <meta charset="utf-8">
    <title>Claude Code A+BAY OpenAI Authorization Failed</title>
  </head>
  <body>
