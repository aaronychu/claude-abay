...
describe('Settings > General tab', () => {
  beforeEach(() => {
    ...
    useSettingsStore.setState({
      ...
      traceCapture: { enabled: true, storageDir: '/Users/test/.claude/claude-abay/traces' },
  ...
  it('lets desktop users choose a custom data directory and relaunch immediately', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByLabelText('Custom data directory')).toHaveValue('/Users/test/claude-abay-data')
    })
