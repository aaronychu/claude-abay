export const en = {
  ...
  'settings.activity.defaultHandle': 'github.com/aaronychu/claude-abay',
  ...
  'settings.terminal.description': 'Run host-machine commands for plugin, skill, and MCP setup. The desktop app includes claude-abay; replace documented claude <args> with claude-abay <args>, for example: claude-abay plugin install ... or claude-abay mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': 'Clears only: claude-abay-open-tabs, claude-abay-session-runtime, claude-abay-theme, claude-abay-locale, and claude-abay.persistence.schemaVersion.',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/claude-abay/settings.json — edit directly, will be written on save.',
  ...
  'settings.skills.installTitle': 'Add skills',
  'settings.skills.installDescription': 'Choose one or more skill folders, or choose zip archives to extract into the skills directory. Existing skills with the same name are updated.',
  'settings.skills.addFolders': 'Add folders',
  'settings.skills.addZips': 'Add ZIP',
  'settings.skills.chooseFolders': 'Choose skill folders',
  'settings.skills.chooseZips': 'Choose skill ZIP files',
  'settings.skills.installing': 'Adding...',
  'settings.skills.installDesktopOnly': 'Adding skills requires the desktop app runtime.',
  'settings.skills.installSuccess': 'Added {count} skills.',
  'settings.skills.installMixed': 'Added {installed} skills and skipped {skipped} items.',
  'settings.skills.installSkipped': 'No new skills were added. Skipped {count} items.',
  ...
  'settings.general.storagePortableDirPlaceholder': 'Choose a folder for claude-abay data',
  ...
  'settings.general.storageMoveHint': 'Switching directories does not migrate existing data. Copy projects, skills, plugins, claude-abay, and related folders from the old directory if you want old sessions to keep appearing. For a portable bundle, keep this folder beside the app and zip them together.',
  ...
  'settings.general.notificationsTestTitle': 'Claude Code A+BAY notifications are enabled',
  ...
  'settings.general.traceHintOn': 'New sessions write compact requests, responses, and status events to the local claude-abay traces directory.',
