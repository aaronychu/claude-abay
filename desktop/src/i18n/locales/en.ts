export const en = {
  ...
  'settings.diagnostics.doctorSafeKeys': 'Reset removes only: claude-abay-open-tabs, claude-abay-session-runtime, claude-abay-theme, claude-abay-locale, claude-abay-app-zoom, claude-abay-ui-zoom, and claude-abay.persistence.schemaVersion.',
  ...
  'settings.skills.installTitle': 'Install skills',
  'settings.skills.installDescription': 'Import one or more folders, or upload zip archives to unpack into your Skills directory.',
  'settings.skills.addFolders': 'Add folders',
  'settings.skills.addZips': 'Add zip files',
  ...
  'settings.skills.installDesktopOnly': 'Skill upload is only available in the desktop app.',
  'settings.skills.installMixed': 'Installed {installed} skills, skipped {skipped}.',
  'settings.skills.installSuccess': 'Installed {count} skills.',
  'settings.skills.installSkipped': 'Skipped {count} items.',
