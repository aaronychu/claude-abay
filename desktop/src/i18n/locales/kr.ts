...
export const kr: Record<TranslationKey, string> = {
  ...
  'settings.terminal.description': '플러그인, 스킬, MCP 설정을 위해 호스트 컴퓨터의 명령을 실행합니다. 데스크톱 앱에는 claude-abay가 포함되어 있습니다. 문서의 claude <args>를 claude-abay <args>로 바꾸세요. 예: claude-abay plugin install ... 또는 claude-abay mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': '다음만 지웁니다: claude-abay-open-tabs, claude-abay-session-runtime, claude-abay-theme, claude-abay-locale, claude-abay.persistence.schemaVersion.',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/claude-abay/settings.json — 직접 편집할 수 있습니다. 저장 시 기록됩니다.',
  ...
  'settings.skills.installTitle': '스킬 추가',
  'settings.skills.installDescription': '하나 이상의 스킬 폴더를 선택하거나 zip 아카이브를 선택해 skills 디렉터리에 압축 해제합니다. 같은 이름의 기존 스킬은 업데이트됩니다.',
  'settings.skills.addFolders': '폴더 추가',
  'settings.skills.addZips': 'ZIP 추가',
  'settings.skills.chooseFolders': '스킬 폴더 선택',
  'settings.skills.chooseZips': '스킬 ZIP 파일 선택',
  'settings.skills.installing': '추가 중...',
  'settings.skills.installDesktopOnly': '스킬 추가에는 데스크톱 앱 런타임이 필요합니다.',
  'settings.skills.installSuccess': '스킬 {count}개를 추가했습니다.',
  'settings.skills.installMixed': '스킬 {installed}개를 추가하고 {skipped}개 항목을 건너뛰었습니다.',
  'settings.skills.installSkipped': '새 스킬이 추가되지 않았습니다. {count}개 항목을 건너뛰었습니다.',
  ...
  'settings.general.storagePortableDirPlaceholder': 'claude-abay 데이터용 폴더 선택',
  ...
  'settings.general.storageMoveHint': '디렉터리를 전환해도 기존 데이터는 마이그레이션되지 않습니다. 이전 세션을 계속 표시하려면 이전 디렉터리에서 projects, skills, plugins, claude-abay 및 관련 폴더를 복사하세요. 포터블 번들의 경우 이 폴더를 앱 옆에 두고 함께 압축하세요.',
  ...
  'settings.general.notificationsTestTitle': 'Claude Code A+BAY 알림이 사용 설정되었습니다',
  ...
  'settings.general.traceHintOn': '새 세션은 간결한 요청, 응답, 상태 이벤트를 로컬 claude-abay traces 디렉터리에 기록합니다.',
