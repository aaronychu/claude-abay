...
export const kr: Record<TranslationKey, string> = {
  ...
  'settings.diagnostics.doctorSafeKeys': '재설정 시 다음 항목만 제거합니다: claude-abay-open-tabs, claude-abay-session-runtime, claude-abay-theme, claude-abay-locale, claude-abay-app-zoom, claude-abay-ui-zoom, claude-abay.persistence.schemaVersion.',
  ...
  'settings.skills.installTitle': '스킬 설치',
  'settings.skills.installDescription': '하나 이상의 폴더를 가져오거나 zip 아카이브를 업로드해 Skills 디렉터리에 압축 해제합니다.',
  'settings.skills.addFolders': '폴더 추가',
  'settings.skills.addZips': 'zip 파일 추가',
  'settings.skills.installing': '설치 중...',
  'settings.skills.chooseFolders': '스킬 폴더 선택',
  'settings.skills.chooseZips': '스킬 zip 파일 선택',
  'settings.skills.installDesktopOnly': '스킬 업로드는 데스크톱 앱에서만 사용할 수 있습니다.',
  'settings.skills.installMixed': '스킬 {installed}개를 설치하고 {skipped}개 항목을 건너뛰었습니다.',
  'settings.skills.installSuccess': '스킬 {count}개를 설치했습니다.',
  'settings.skills.installSkipped': '{count}개 항목을 건너뛰었습니다.',
