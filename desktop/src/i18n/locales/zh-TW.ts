...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.diagnostics.doctorSafeKeys': '重設只會移除：claude-abay-open-tabs、claude-abay-session-runtime、claude-abay-theme、claude-abay-locale、claude-abay-app-zoom、claude-abay-ui-zoom 和 claude-abay.persistence.schemaVersion。',
  ...
  'settings.skills.installTitle': '安裝技能',
  'settings.skills.installDescription': '匯入一個或多個資料夾，或上傳 zip 壓縮包並自動解壓到 Skills 目錄。',
  'settings.skills.addFolders': '新增資料夾',
  'settings.skills.addZips': '新增 zip 檔案',
  'settings.skills.installing': '安裝中...',
  'settings.skills.chooseFolders': '選擇技能資料夾',
  'settings.skills.chooseZips': '選擇技能 zip 檔案',
  'settings.skills.installDesktopOnly': '技能上傳僅在桌面端可用。',
  'settings.skills.installMixed': '已安裝 {installed} 個技能，跳過 {skipped} 項。',
  'settings.skills.installSuccess': '已安裝 {count} 個技能。',
  'settings.skills.installSkipped': '已跳過 {count} 項。',
