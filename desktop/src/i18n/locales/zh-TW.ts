...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.terminal.description': '直接執行宿主機命令，用於安裝外掛、Skills、MCP 等擴充套件。桌面端已內建 claude-abay；文件裡的 claude <引數> 可替換成 claude-abay <引數>，例如 claude-abay plugin install ... 或 claude-abay mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': '只會清理：claude-abay-open-tabs、claude-abay-session-runtime、claude-abay-theme、claude-abay-locale 和 claude-abay.persistence.schemaVersion。',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/claude-abay/settings.json — 直接編輯，儲存時寫入。',
  ...
  'settings.skills.installTitle': '新增技能',
  'settings.skills.installDescription': '選擇一個或多個技能資料夾，或選擇 zip 檔自動解壓到 skills 目錄。同名技能會被更新覆蓋。',
  'settings.skills.addFolders': '新增資料夾',
  'settings.skills.addZips': '新增 ZIP',
  'settings.skills.chooseFolders': '選擇技能資料夾',
  'settings.skills.chooseZips': '選擇技能 ZIP 檔',
  'settings.skills.installing': '新增中...',
  'settings.skills.installDesktopOnly': '新增技能需要桌面端執行環境。',
  'settings.skills.installSuccess': '已新增 {count} 個技能。',
  'settings.skills.installMixed': '已新增 {installed} 個技能，跳過 {skipped} 項。',
  'settings.skills.installSkipped': '沒有新增新技能，跳過 {count} 項。',
  ...
  'settings.general.storagePortableDirPlaceholder': '選擇一個用於儲存 claude-abay 資料的資料夾',
  ...
  'settings.general.storageMoveHint': '切換目錄不會自動搬遷舊資料。如果希望舊會話繼續出現，請把原目錄下的 projects、skills、plugins、claude-abay 等資料複製到新目錄。要做便攜包，建議把目錄放在應用旁邊並一起壓縮。',
  ...
  'settings.general.notificationsTestTitle': 'Claude Code A+BAY 通知已啟用',
  ...
  'settings.general.traceHintOn': '新會話會把精簡請求、回應、狀態事件寫入本機 claude-abay traces 目錄。',
