...
export const jp: Record<TranslationKey, string> = {
  ...
  'settings.diagnostics.doctorSafeKeys': 'リセットで削除されるのは次のみ: claude-abay-open-tabs、claude-abay-session-runtime、claude-abay-theme、claude-abay-locale、claude-abay-app-zoom、claude-abay-ui-zoom、claude-abay.persistence.schemaVersion。',
  ...
  'settings.skills.installTitle': 'スキルをインストール',
  'settings.skills.installDescription': '1つ以上のフォルダを取り込むか、zip アーカイブをアップロードして Skills ディレクトリへ展開します。',
  'settings.skills.addFolders': 'フォルダを追加',
  'settings.skills.addZips': 'zip ファイルを追加',
  'settings.skills.installing': 'インストール中...',
  'settings.skills.chooseFolders': 'スキルフォルダを選択',
  'settings.skills.chooseZips': 'スキル zip ファイルを選択',
  'settings.skills.installDesktopOnly': 'スキルのアップロードはデスクトップアプリでのみ利用できます。',
  'settings.skills.installMixed': '{installed} 個のスキルをインストールし、{skipped} 件をスキップしました。',
  'settings.skills.installSuccess': '{count} 個のスキルをインストールしました。',
  'settings.skills.installSkipped': '{count} 件をスキップしました。',
