...
export const jp: Record<TranslationKey, string> = {
  ...
  'settings.terminal.description': 'プラグイン、スキル、MCP のセットアップ用にホストマシンのコマンドを実行します。デスクトップアプリには claude-abay が含まれています。ドキュメントの claude <args> を claude-abay <args> に置き換えてください。例: claude-abay plugin install ... や claude-abay mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': 'クリアされるのは次のみ: claude-abay-open-tabs、claude-abay-session-runtime、claude-abay-theme、claude-abay-locale、claude-abay.persistence.schemaVersion。',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/claude-abay/settings.json — 直接編集できます。保存時に書き込まれます。',
  ...
  'settings.skills.installTitle': 'スキルを追加',
  'settings.skills.installDescription': '1 つ以上のスキルフォルダ、または zip アーカイブを選んで skills ディレクトリに展開します。同名の既存スキルは更新されます。',
  'settings.skills.addFolders': 'フォルダを追加',
  'settings.skills.addZips': 'ZIP を追加',
  'settings.skills.chooseFolders': 'スキルフォルダを選択',
  'settings.skills.chooseZips': 'スキル ZIP ファイルを選択',
  'settings.skills.installing': '追加中...',
  'settings.skills.installDesktopOnly': 'スキルの追加にはデスクトップアプリ環境が必要です。',
  'settings.skills.installSuccess': '{count} 個のスキルを追加しました。',
  'settings.skills.installMixed': '{installed} 個のスキルを追加し、{skipped} 件をスキップしました。',
  'settings.skills.installSkipped': '新しいスキルは追加されませんでした。{count} 件をスキップしました。',
  ...
  'settings.general.storagePortableDirPlaceholder': 'claude-abay データ用のフォルダを選択',
  ...
  'settings.general.storageMoveHint': 'ディレクトリを切り替えても既存のデータは移行されません。以前のセッションを引き続き表示したい場合は、古いディレクトリから projects、skills、plugins、claude-abay および関連フォルダをコピーしてください。ポータブルバンドルにする場合は、このフォルダをアプリの隣に置いて一緒に zip 化してください。',
  ...
  'settings.general.notificationsTestTitle': 'Claude Code A+BAY の通知が有効になりました',
  ...
  'settings.general.traceHintOn': '新しいセッションは、簡潔な要求、応答、状態イベントをローカルの claude-abay traces ディレクトリに書き込みます。',
