...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.diagnostics.doctorSafeKeys': '重置只会移除：claude-abay-open-tabs、claude-abay-session-runtime、claude-abay-theme、claude-abay-locale、claude-abay-app-zoom、claude-abay-ui-zoom 和 claude-abay.persistence.schemaVersion。',
  ...
  'settings.skills.installTitle': '安装技能',
  'settings.skills.installDescription': '导入一个或多个文件夹，或上传 zip 压缩包并自动解压到 Skills 目录。',
  'settings.skills.addFolders': '添加文件夹',
  'settings.skills.addZips': '添加 zip 文件',
  'settings.skills.installing': '安装中...',
  'settings.skills.chooseFolders': '选择技能文件夹',
  'settings.skills.chooseZips': '选择技能 zip 文件',
  'settings.skills.installDesktopOnly': '技能上传仅在桌面端可用。',
  'settings.skills.installMixed': '已安装 {installed} 个技能，跳过 {skipped} 项。',
  'settings.skills.installSuccess': '已安装 {count} 个技能。',
  'settings.skills.installSkipped': '已跳过 {count} 项。',
