...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.terminal.description': '直接运行宿主机命令，用于安装插件、Skills、MCP 等扩展。桌面端已内置 claude-abay；文档里的 claude <参数> 可替换成 claude-abay <参数>，例如 claude-abay plugin install ... 或 claude-abay mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': '只会清理：claude-abay-open-tabs、claude-abay-session-runtime、claude-abay-theme、claude-abay-locale 和 claude-abay.persistence.schemaVersion。',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/claude-abay/settings.json — 直接编辑，保存时写入。',
  ...
  'settings.skills.installTitle': '添加技能',
  'settings.skills.installDescription': '选择一个或多个技能文件夹，或选择 zip 包自动解压到 skills 目录。同名技能会被更新覆盖。',
  'settings.skills.addFolders': '添加文件夹',
  'settings.skills.addZips': '添加 ZIP',
  'settings.skills.chooseFolders': '选择技能文件夹',
  'settings.skills.chooseZips': '选择技能 ZIP',
  'settings.skills.installing': '添加中...',
  'settings.skills.installDesktopOnly': '添加技能需要桌面端运行环境。',
  'settings.skills.installSuccess': '已添加 {count} 个技能。',
  'settings.skills.installMixed': '已添加 {installed} 个技能，跳过 {skipped} 项。',
  'settings.skills.installSkipped': '没有添加新技能，跳过 {count} 项。',
  ...
  'settings.general.storagePortableDirPlaceholder': '选择一个用于保存 claude-abay 数据的文件夹',
  ...
  'settings.general.storageMoveHint': '切换目录不会自动搬迁旧数据。如果希望旧会话继续出现，请把原目录下的 projects、skills、plugins、claude-abay 等数据复制到新目录。要做便携包，建议把目录放在应用旁边并一起压缩。',
  ...
  'settings.general.notificationsTestTitle': 'Claude Code A+BAY 通知已启用',
  ...
  'settings.general.traceHintOn': '新会话会把精简请求、响应、状态事件写入本机 claude-abay traces 目录。',
