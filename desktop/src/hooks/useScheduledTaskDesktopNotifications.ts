...
const NOTIFIED_RUNS_STORAGE_KEY = 'claude-abay.notifiedDesktopTaskRuns.v1'
const NOTIFICATION_SCAN_STORAGE_KEY = 'claude-abay.scheduledTaskNotificationScan.v1'
