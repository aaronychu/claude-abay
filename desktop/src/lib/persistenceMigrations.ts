...
export const DESKTOP_PERSISTENCE_VERSION_KEY = 'claude-abay.persistence.schemaVersion'
...
const TAB_STORAGE_KEY = 'claude-abay-open-tabs'
const SESSION_RUNTIME_STORAGE_KEY = 'claude-abay-session-runtime'
const THEME_STORAGE_KEY = 'claude-abay-theme'
const LOCALE_STORAGE_KEY = 'claude-abay-locale'
