...
SESSION_NAME="claude-abay-rewind-complex-e2e-${RUN_ID}"
ARTIFACT_DIR="$(mktemp -d "/tmp/claude-abay-rewind-complex-e2e-${RUN_ID}-XXXX")"
...
${AB} open "${WEB_URL}"
${AB} wait 2000
${AB} eval "localStorage.setItem('claude-abay-locale', 'en'); location.reload();"
${AB} wait 2000
