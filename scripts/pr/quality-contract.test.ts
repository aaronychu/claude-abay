...
describe('feature quality contract', () => {
  ...
  test('keeps quality policy and cross-process boundaries maintainer-owned', () => {
    ...
    expect(codeowners).toContain('/.github/workflows/ @aaronychu')
    expect(codeowners).toContain('/AGENTS.md @aaronychu')
    expect(codeowners).toContain('**/AGENTS.md @aaronychu')
    expect(codeowners).toContain('/CONTRIBUTING.md @aaronychu')
    expect(codeowners).toContain('/scripts/pr/ @aaronychu')
    expect(codeowners).toContain('/scripts/quality-gate/ @aaronychu')
    expect(codeowners).toContain('/desktop/src/api/websocket* @aaronychu')
    expect(codeowners).toContain('/desktop/src/lib/persistenceMigrations* @aaronychu')
    expect(codeowners).toContain('/src/server/services/conversationService* @aaronychu')
    expect(codeowners).toContain('/src/server/proxy/ @aaronychu')
    expect(codeowners).toContain('/src/server/ws/ @aaronychu')
    expect(codeowners).toContain('/src/services/openaiAuth/ @aaronychu')
    expect(codeowners).toContain('/src/utils/model/ @aaronychu')
  })
